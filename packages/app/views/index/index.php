	...
	<div class="row content">
		...
		<div class="large-4 columns">
			<h3>&nbsp;</h3>
			<div class="panel">
				<h5 class="subheader">Current <?php echo config::name(); ?> Version: </h5><a class="small orange centered radius button" href="<?php if(user::loggedin()) echo 'http://code.offthewallmedia.com/jeff/hmvc/repository/archive'; ?>" alt="Download <?php echo config::name() . ' ' . config::version(); ?>" title="Download <?php echo config::name() . ' ' . config::version(); ?>"><i class="icon-download-alt left"></i> <?php echo config::version(); ?> <i class="icon-download-alt right"></i></a>
